...
class StoreResourceQualificationRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()?->can('create', ResourceQualification::class) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'level' => ['nullable', Rule::enum(QualificationLevel::class)],
        ];
    }
}
